        ...
        return (
            <div className={`${style.head_wrap}`}>
                <div className={`${style.head_userInfo}`} >
                    <Link to="" className={`${style.head_pic}`}>
                        <img src="http://192.168.1.101:3008/images/default_head.jpg" alt="" />
                    </Link>
                    <div className={`${style.head_description}`}>
                        <h3 className={`${style.head_userName}`}> <Link to="">Canvas</Link> </h3>
                        <span className={`${style.head_habit}`}>坚持<Link className={`${style.head_habitLink}`} to="">#吃早餐#</Link></span>
                    </div>
                </div>
